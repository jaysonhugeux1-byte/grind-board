...
import { buildPots as decouperPots } from "./pots.js";
...
// Le découpage vit dans `pots.js` : c'est de l'arithmétique de pot, valable
// quel que soit le format d'historique. Le garder ici le rendait invisible
// depuis le cash game, qui a donc calculé son EV sur le pot entier.
// Réexporté pour que rien de ce qui importait `buildPots` d'ici ne casse.
...
export function computeSpinHandEV(hand) {
  ...
  const pots = decouperPots(hand.players);
